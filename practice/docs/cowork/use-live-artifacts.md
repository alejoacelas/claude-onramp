...
*Source: https://support.claude.com/en/articles/14729249-use-live-artifacts-in-claude-cowork*  ·  *Fetched: 2026-07-07*

---

This article explains how to use live artifacts in **[Claude Cowork](https://claude.com/product/cowork)**. Live artifacts are persistent, interactive HTML dashboards that Claude builds for you. They refresh with current data from your connected apps and live in their own tab across tasks.
...
**Note:** Live artifacts are available on the desktop app only. If you use Cowork on web or mobile, you won't see the **" Live artifacts"** tab there.

* * *

## What are live artifacts?

A live artifact is a persistent, interactive HTML page that Claude creates for you in Cowork, shaped around your specific work. It might be a tracker, a dashboard, a comparison tool, or a reference. Every live artifact you create is saved to the “Live artifacts” tab in Cowork, and you can reopen, refresh, and iterate on it from any future session.
...
Artifacts Claude creates in chat or Cowork now show up together in one artifacts view. Live artifacts are separate: they stay on the desktop app and appear in the “Live artifacts” tab in Cowork.
